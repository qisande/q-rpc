...
public class SpiLoader {
     ...
     * 系统 SPI 目录
     */
    private static final String PRC_SYSTEM_SPI_DIR = "META-INF/rpc/system/";
     ...
     * 扫描路径
     */
    private static final String[] SCAN_DIR = new String[]{PRC_SYSTEM_SPI_DIR, PRC_CUSTOM_SPI_DIR};
